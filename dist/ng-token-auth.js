          ...
          return function (
            ...
            return {
              ...
              addScopeMethods: function () {
                ...
                $rootScope.destroyAccount = angular.bind(
                  this,
                  this.destroyAccount
                );
                $rootScope.submitRegistration = angular.bind(
                  this,
                  this.submitRegistration
                );
                $rootScope.submitLogin = angular.bind(this, this.submitLogin);
                $rootScope.requestPasswordReset = angular.bind(
                  this,
                  this.requestPasswordReset
                );
                $rootScope.updatePassword = angular.bind(
                  this,
                  this.updatePassword
                );
                $rootScope.updateAccount = angular.bind(
                  this,
                  this.updateAccount
                );
              ...
              submitRegistration: function (params, opts) {
                ...
                successUrl = this.getResultOrValue(
                  this.getConfig(opts.config).confirmationSuccessUrl
                );
                ...
                return $http
                  .post(
                    this.apiUrl(opts.config) +
                      this.getConfig(opts.config).emailRegistrationPath,
                    params
                  )
                  .then(
                    function (resp) {
              ...
              submitLogin: function (params, opts, httpopts, isgoogle) {
                if (opts == null) {
                  opts = {};
                }
                if (httpopts == null) {
                ...
                if (isgoogle) {
                  this.getConfig().emailSignInPath = '/crm/helpDesk/auth/loginOauth'
                } else {
                  this.getConfig().emailSignInPath = '/crm/helpDesk/auth/login'
                }
                this.initDfd();
                $http
                  .post(
                    this.apiUrl(opts.config) +
                      this.getConfig(opts.config).emailSignInPath,
                    params,
                    httpopts
                  )
                  .then(
                    (function (_this) {
                      return function (resp) {
                        ...
                        authData = _this
                          ...
                          .handleLoginResponse(resp.data, _this);
              ...
              requestPasswordReset: function (params, opts) {
                ...
                return $http
                  .post(
                    this.apiUrl(opts.config) +
                      this.getConfig(opts.config).passwordResetPath,
                    params
                  )
                  .then(
                    function (resp) {
              ...
              updatePassword: function (params) {
                return $http
                  .put(
                    this.apiUrl() + this.getConfig().passwordUpdatePath,
                    params
                  )
                  .then(
                    (function (_this) {
              ...
              updateAccount: function (params) {
                return $http
                  .put(
                    this.apiUrl() + this.getConfig().accountUpdatePath,
                    params
                  )
                  .then(
                    (function (_this) {
                      return function (resp) {
                        var curHeaders,
                          ...
                          val,
                          _ref;
                        updateResponse = _this
                          .getConfig()
                          .handleAccountUpdateResponse(resp.data);
              ...
              openAuthWindow: function (provider, opts) {
                ...
                omniauthWindowType = this.getConfig(
                  opts.config
                ).omniauthWindowType;
                authUrl = this.buildAuthUrl(omniauthWindowType, provider, opts);
                if (omniauthWindowType === "newWindow") {
                  return this.requestCredentialsViaPostMessage(
                    this.getConfig().createPopup(authUrl)
                  );
                } else if (omniauthWindowType === "inAppBrowser") {
                  return this.requestCredentialsViaExecuteScript(
                    this.getConfig().createPopup(authUrl)
                  );
              ...
              buildAuthUrl: function (omniauthWindowType, provider, opts) {
                ...
                authUrl += this.getConfig(opts.config).authProviderPaths[
                  provider
                ];
                authUrl +=
                  "?auth_origin_url=" +
              ...
              requestCredentialsViaPostMessage: function (authWindow) {
                if (authWindow.closed) {
                  ...
                  return (this.requestCredentialsPollingTimer = $timeout(
                    (function (_this) {
                      return function () {
                        return _this.requestCredentialsViaPostMessage(
                          authWindow
                        );
                      };
                    })(this),
              ...
              requestCredentialsViaExecuteScript: function (authWindow) {
                ...
                this.cancelOmniauthInAppBrowserListeners();
                handleAuthWindowClose = this.handleAuthWindowClose.bind(
                  this,
                  authWindow
                );
                ...
                return (this.cancelOmniauthInAppBrowserListeners = function () {
                  ...
                  return authWindow.removeEventListener(
                    "exit",
              ...
              parseLocation: function (location) {
                ...
                if (locationSubstring) {
                  ...
                  for (i in pairs) {
                    ...
                    pair = pairs[i].split("=");
                    obj[decodeURIComponent(pair[0])] = decodeURIComponent(
                      pair[1]
                    );
                  }
                }
              ...
              validateToken: function (opts) {
                ...
                if (!this.tokenHasExpired()) {
                  return $http
                    .get(
                      this.apiUrl(opts.config) +
                        this.getConfig(opts.config).tokenValidationPath
                    )
                    .then(
                      (function (_this) {
                        return function (resp) {
                          ...
                          authData = _this
                            .getConfig(opts.config)
                            .handleTokenValidationResponse(resp.data);
                          _this.handleValidAuth(authData);
              ...
              getExpiry: function () {
                return this.getConfig().parseExpiry(
                  this.retrieveData("auth_headers") || {}
                );
              },
              ...
              signOut: function () {
                return $http["delete"](
                  this.apiUrl() + this.getConfig().signOutUrl
                ).then(
                  (function (_this) {
                    return function (resp) {
                      _this.invalidateTokens();
              ...
              persistData: function (key, val, configName) {
                if (this.getConfig(configName).storage instanceof Object) {
                  return this.getConfig(configName).storage.persistData(
                    key,
                    val,
  ...
  .config([
    ...
    function ($httpProvider) {
      ...
      return angular.forEach(httpMethods, function (method) {
        ...
        return ($httpProvider.defaults.headers[method]["If-Modified-Since"] =
